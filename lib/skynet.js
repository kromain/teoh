...
/**
 * Mark a pause using SkyNet.wait. If seconds is provided, it sets the pause time in seconds.
 *
 * To actually pause the execution, call markPause without arguments. The pause time should be set first.
 *
 */
function markPause(seconds) {
    if (seconds > 0) {
...
SkyNet.prototype.markPause = markPause;
