...
function loadTLXSandbox() {
    var url = SkyNet.option("webRoot") + "/SkyNet.html";
    DriverInstance.navigateTo(url);
    SkyNet.waitFor("window.SkyNet !== undefined", "SkyNet");
}
...
function loadComponent(component, attributes) {
    ...
    SkyNet.waitFor("window.SkyNet.tlxLoaded", "TLX component to load");
}
